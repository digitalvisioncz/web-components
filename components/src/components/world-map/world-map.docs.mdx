...
## With Regions Tooltip
<Canvas of={WorldMapStories.WithRegionsTooltip} />

## With Regions Click
<Canvas of={WorldMapStories.WithRegionsClick} />

## With Tooltip Title Only
<Canvas of={WorldMapStories.WithTooltipTitleOnly} />

## With Tooltip Description Only
<Canvas of={WorldMapStories.WithTooltipDescriptionOnly} />

## With Tooltip Click
<Canvas of={WorldMapStories.WithTooltipClick} />

## With CSS Variables
<Canvas of={WorldMapStories.WithCSSVariables} />

## With Regions Click Tooltip Click
<Canvas of={WorldMapStories.WithRegionsClickTooltipClick} />